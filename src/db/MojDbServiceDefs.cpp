...
// property keys
const MojChar* const MojDbServiceDefs::AssignIdKey = _T("assignId");
...
const MojChar* const MojDbServiceDefs::KeysKey = _T("key");
...
const MojChar* const MojDbServiceDefs::LocaleKey = _T("localeInfo");
...
const MojChar* const MojDbServiceDefs::OwnersKey = _T("owners");
const MojChar* const MojDbServiceDefs::ProfileEnableKey = _T("enable");
const MojChar* const MojDbServiceDefs::ProfileApplicationKey = _T("application");
// property values
...
const MojChar* const MojDbServiceDefs::ReleaseAdminProfileMethod = _T("releaseAdminProfile");
...
const MojChar* const MojDbServiceDefs::RemoveAppDataMethod = _T("removeAppData");
// service name
...
const MojChar* const MojDbServiceDefs::ASMResponseDeviceStatusMethod = _T("responseDeviceStatus");
const MojChar* const MojDbServiceDefs::ASMUnRegisterDeviceStatusMethod = _T("unregisterDeviceStatus");
const MojChar* const MojDbServiceDefs::ASMDeviceStatusEjecting = _T("EJECTING");
const MojChar* const MojDbServiceDefs::ASMDeviceStatusFormatting = _T("FORMATTING");
